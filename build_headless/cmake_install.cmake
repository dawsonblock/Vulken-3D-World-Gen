...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("/Users/dawsonblock/Vulken-3D-World-Gen/Vulken-3D-World-Gen/build_headless/apps/cmake_install.cmake")
endif()

if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  # Include the install script for the subdirectory.
  include("/Users/dawsonblock/Vulken-3D-World-Gen/Vulken-3D-World-Gen/build_headless/tools/cmake_install.cmake")
endif()

if(CMAKE_INSTALL_COMPONENT STREQUAL "Runtime" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/Users/dawsonblock/Vulken-3D-World-Gen/Vulken-3D-World-Gen/build_headless/VoxelVK_Elite_ALL")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/VoxelVK_Elite_ALL" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" -u -r "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/VoxelVK_Elite_ALL")
    endif()
  endif()
endif()

if(CMAKE_INSTALL_COMPONENT STREQUAL "Runtime" OR NOT CMAKE_INSTALL_COMPONENT)
  include("/Users/dawsonblock/Vulken-3D-World-Gen/Vulken-3D-World-Gen/build_headless/CMakeFiles/VoxelVK_Elite_ALL.dir/install-cxx-module-bmi-RelWithDebInfo.cmake" OPTIONAL)
endif()
...
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/Users/dawsonblock/Vulken-3D-World-Gen/Vulken-3D-World-Gen/build_headless/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/Users/dawsonblock/Vulken-3D-World-Gen/Vulken-3D-World-Gen/build_headless/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
