...
if(ENABLE_GRAPHICS)
  ...
  find_program(GLSLC glslc
    HINTS
      ...
      "${CMAKE_BINARY_DIR}/vcpkg_installed/${VCPKG_HOST_TRIPLET}/tools/shaderc"
  )
  if(NOT GLSLC)
    ...
    if(NOT GLSLANG_VALIDATOR)
      message(WARNING "Neither glslc nor glslangValidator found. Shader compilation will be skipped.")
  ...
  if(SHADER_COMPILATION_AVAILABLE)
    ...
    add_custom_target(ShaderSPV)
    message(STATUS "Shader compilation disabled - no shader tools available")
  endif()
else()
  # Graphics disabled - create empty shader target
  add_custom_target(ShaderSPV)
  message(STATUS "Shader compilation disabled - graphics not enabled")
endif()
